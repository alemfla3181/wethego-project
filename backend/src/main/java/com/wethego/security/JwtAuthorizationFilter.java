...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
	...
	public JwtAuthorizationFilter(AuthenticationManager authenticationManager, EmployeesRepository employeesRepository) {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		String userId = 
				JWT.require(Algorithm.HMAC512("cos")).build().verify(jwtToken).getClaim("userId").asString();
