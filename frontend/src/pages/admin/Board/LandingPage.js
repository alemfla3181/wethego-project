...
import { Box, Button, FormControl, InputLabel, MenuItem, Pagination, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow } from "@mui/material";
...
const LandingPage = () => {
  ...
  const [dpt, setDpt] = useState(null) // 부서명 조회 
  ...
  const fetchData = async () => {
    try {
      ...
      await axios.get("/api/board/dpt").then((res)=>{
        setDpt(res.data.data)
      })
      ...
      <div className="container">
        ...
        <Paper elevation={5} style={{padding: "3% 5% 10%"}}>
          ...
          <div style={{ width:'100%', height:'100%'}}>
            ...
            <FormControl className="adminBoardUpper" margin='normal' style={{width:'12%', marginRight : '4%'}}>
            ...
            <div className="adminBoardUpper" style={{ textAlign:'right', width:'64%'}}>

              <Button 
                variant="contained" size="medium" color="primary" style={{ marginTop: "15px", marginRight:'5%' }}  onClick={()=>{
                create();
              }}>글 생성</Button>
              ...
              <FormControl margin='normal' >
                ...
                <Select
                  ...
                  { dpt != null ? dpt.map((e,i)=>
                    <MenuItem key={i} value={e.dname}>{e.dname}</MenuItem>
                  ) : null}
                </Select>
              </FormControl>
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                ...
                <TableRow hover style={{cursor: "pointer", textDecoration: "none"}} onClick={event=>{ 
